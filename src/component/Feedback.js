...
import { Swiper, SwiperSlide } from 'swiper/react'; // Import Swiper component
import 'swiper/css';
        ...
        <main className='feedback'>
            ...
            <section className='feedbackBodyContainer'>
                {isMobile ? (
                    ...
                    >
                        {feedbackArray.map((feedback, index) => (
                            <SwiperSlide key={index}>
                                <FeedbackCard name={feedback.name} index={index} feedback={feedback.feedback} img={feedback.img} position={feedback.position} />
                            </SwiperSlide>
                        ))}
                    ...
                    feedbackArray.map((feedback, index) => (
                        <FeedbackCard key={index} name={feedback.name} index={index} feedback={feedback.feedback} img={feedback.img} position={feedback.position} />
                    ))
                )}
            </section>
        </main>
